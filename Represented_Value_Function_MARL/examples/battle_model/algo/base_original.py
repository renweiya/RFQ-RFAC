...
class ValueNet:
    def __init__(self, sess, env, handle, name, update_every=5, use_mf=False, learning_rate=1e-4, tau=0.005, gamma=0.95,use_gat_attn=False):
        ...
        self.tau = tau
        self.gamma = gamma
        self.use_gat_attn = use_gat_attn
