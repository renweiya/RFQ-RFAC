...
class AgentMemory(object):
    ...
    def append(self, obs0, feat0, act, reward, alive, prob=None):
        # print("obs1111",obs0.shape)
        # print("obs0000",np.array([obs0]).shape)

        # print("feat01111",feat0.shape)
        # print("feat00000",np.array([feat0]).shape)
...
class MemoryGroup(object):
    ...
    def tight(self):
        ...
        for ele in ids:
            ...
            # print('ele:',ele,',[INFO]obs0---:',tmp['obs0'].shape)#max_steps
            # print('ele:',ele,',[INFO]feat0---:',tmp['feat0'].shape)#max_steps
            # print('ele:',ele,',[INFO]act---:',tmp['act'].shape)#max_steps
            self._flush(**tmp)
...
class Runner(object):
    ...
    def run(self, variant_eps, iteration, win_cnt=None):
        ...
        if self.train:
            print('\n[main-INFO] {}'.format(info['main']))
            print('\n[oppo-INFO] {}'.format(info['opponent']))
